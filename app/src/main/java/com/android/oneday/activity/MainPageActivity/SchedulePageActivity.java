 ...
 * TODO this coding.
 */
public class SchedulePageActivity extends BaseActivity implements OnGestureListener{
    ...
    private void addGridView() {
        ...
        gridView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                return SchedulePageActivity.this.gestureDetector.onTouchEvent(event);
            }
        });
